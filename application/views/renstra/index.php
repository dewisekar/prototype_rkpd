...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <!-- Main Content -->
            <div id="content" style="background-color: #AA3833">
                <!-- Topbar -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600"><b>OPD</b></span>
                ...
                <div class="card mb-0 border-0 rounded-0">
                    ...
                    <div class="card-header pb-0 pt-0 pl-0 pr-0 d-flex flex-row align-items-center justify-content-between rounded-0 " style="background-color:rgb(36, 167, 95);border:0;">
                        <div class="col-2 py-4" style="background-color: #E7614E;">
                            <a href="#" style="display: block; text-decoration: none;">
                            Penyusunan
                            </a>
                        </div>
                        <div class="col-2 py-4" style="background-color: #F7F9F8;">
                            <a href="#" style="display: block; text-decoration: none;">
                            Penetapan
                            </a>
                        </div>
                        <div class="col-8 py-4" style="background-color: #F7F9F8;">
                        <muted>.</muted>
                        </div>
                    </div>

                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between rounded-0 "
                        style="background-color:#AA3833;border:0;">
                ...
                <!-- Begin Page Content -->
                <div class="container-fluid" style="background-color: #AA3833">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-9" style="background-color: rgb(170, 235, 221)">
                                    <div class="my-3">
                                        <a style="font-size: 16px">1. Terwujudnya pendidikan kota Malang yang berkualitas dan terjangkau bagi masyarakat</a>
                                    </div>
                                </div>
                                <div class="col-3" style="background-color: rgb(235, 137, 72)">
                                    <div class="my-3">
                                        <a class="mr-auto" style="color:white;font-size: 16px">Rp 1.650.000.000</a>
                            ...
                            <div class="row mb-3">
                                <table class="table table-bordered text-center">
                                    <thead>
                                        <tr>
                                            <th scope="col" width="50%"><small>Indikator Tujuan</small></th>
                                            <th scope="col"><small>Satuan</small></th>
                                            <th scope="col"><small>Kondisi Awal</small></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><b>Angka Kelulusan SMP/ Mts</b></td>
                                            <td>%</td>
                                            <td>99.63</td>
                                            <td>99.63</td>
                                            <td>99.64</td>
                                        ...
                                        <tr>
                                            <td><b>Angka Kelulusan SMA/ SMK</b></td>
                                            <td>%</td>
                                            <td>99.63</td>
                                            <td>99.63</td>
                                            <td>99.64</td>
                            ...
                            <div class="row mb-3">
                                <div class="col-9" style="background-color: rgb(235, 235, 235)">
                                    <div class="my-3">
                                        <a style="font-size: 16px">2. Terwujudnya pendidikan yang terjangkau</a>
                                    </div>
                                </div>
                                <div class="col-3" style="background-color: rgb(235, 137, 72)">
                                    <div class="my-3">
                                        <a class="mr-auto" style="color:white;font-size: 16px">Rp 1.300.000.000</a>
                            ...
                            <div class="row mb-3">
                                <div class="col-9" style="background-color: rgb(235, 235, 235)">
                                    <div class="my-3">
                                        <a style="font-size: 16px">3. Terwujudnya siswa dan siswi berprestasi unggul</a>
                                    </div>
                                </div>
                                <div class="col-3" style="background-color: rgb(235, 137, 72)">
                                    <div class="my-3">
                                        <a class="mr-auto" style="color:white;font-size: 16px">Rp 1.700.000.000</a>
                                        <i class="fas fa-angle-down float-right my-1 mr-2" style="color:white"></i>
                                    </div>
                                </div>
                            </div>
